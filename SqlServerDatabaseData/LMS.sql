...
(
    ...
    USERTYPEID INT NOT NULL FOREIGN KEY REFERENCES USER_TYPE(USERTYPEID),
    CREATED_DT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
	MODIFIED_DT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP    
);
...
(
	...
	USERID INT NOT NULL FOREIGN KEY REFERENCES USERS(USERID),
	CATID INT NOT NULL FOREIGN KEY REFERENCES STUDENT_CATEGORY(CATID),
...
(
	DEPID INT NOT NULL IDENTITY(10,1) PRIMARY KEY,
...
(
	ID INT NOT NULL PRIMARY KEY IDENTITY(100,1),
	USERID INT NOT NULL FOREIGN KEY REFERENCES USERS(USERID), -- Primary Key column
...
CREATE TABLE BOOK
	(
		...
		BOOKCATID INT NOT NULL FOREIGN KEY REFERENCES BOOK_CATEGORY(BOOKCATID),
		USERID INT NOT NULL FOREIGN KEY REFERENCES USERS(USERID),
		CREATED_DT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
		MODIFIED_DT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
	);
...
CREATE TABLE BOOK_ISSUE_LOG
	(
		...
		ISSUEDTO INT NOT NULL FOREIGN KEY REFERENCES USERS(USERID),
...
(
	...
	VERIFICATIONSTATUS TINYINT NOT NULL DEFAULT 0, --0 NOT VERIFIED | 1 VERIFIED,
...
(
	IDENTPASSID INT NOT NULL IDENTITY(10,1) PRIMARY KEY, -- Primary Key column
	PASSWORD NVARCHAR(MAX) NOT NULL,
	ISACTIVE BIT NOT NULL DEFAULT 1, -- 0 NOT ACTIVE | 1 ACTIVE
	USERID INT NOT NULL FOREIGN KEY REFERENCES USERS(USERID),
	VALIDTILL INT NOT NULL DEFAULT 240, --THIS VALUE DETERMINES HOW LONG THE PASSWORD IS VALID FOR SINCE CREATION. CALCULATE BASED ON CREATED_DT
	CREATED_DT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
	MODIFIED_DT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
);
GO
