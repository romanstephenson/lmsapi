...
SELECT * FROM [DBO].[USERS] where USERID = 1000010

SELECT * FROM DBO.EMAIL WHERE USERID = 1000010

SELECT * FROM USER_TYPE_MAPPING WHERE USER_TYPE = 2 AND USER_ID = 1000010 ORDER BY USER_ID ASC
...
SELECT * FROM IDENTITYPASS WHERE USERID = 1000010

-- UPDATE IDENTITYPASS
-- SET ISACTIVE = 1
-- WHERE USERID = 1000010 AND IDENTPASSID = 322
